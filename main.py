...
database_postgre = os.environ.get("SQL_POSTGRE2")
if database_postgre is not None:
    app.config['SQLALCHEMY_DATABASE_URI'] = database_postgre
    app.config['SQLALCHEMY_TRACK_MODIFICATIONS']= False
else:
    app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get("SQL_SQLITE3")
    app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
db = SQLAlchemy(app)
